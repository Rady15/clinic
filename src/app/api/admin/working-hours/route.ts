...
export async function GET(_request: NextRequest) {
  ...
  try {
    const items = await db.workingHour.findMany({ orderBy: { order: 'asc' } });
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const item = await db.workingHour.create({ data });
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const item = await db.workingHour.update({ where: { id }, data: updateData });
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (!id) return errorResponse('ID required', 400);
    await db.workingHour.delete({ where: { id } });
