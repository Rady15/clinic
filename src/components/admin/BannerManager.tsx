...
const fields = [
  ...
  { key: 'ctaTextAr', label: 'نص الزر (عربي)', type: 'text' as const },
  { key: 'ctaTextEn', label: 'نص الزر (إنجليزي)', type: 'text' as const },
  { key: 'ctaLink', label: 'رابط الزر', type: 'text' as const },
  { key: 'image', label: 'banner', type: 'image' as const },
